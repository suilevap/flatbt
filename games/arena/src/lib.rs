...
//!
//! [`ai`] is the part under test: one blackboard component, three systems that
//! fill it at three different rates, three enemy minds over it, and one system
//! that carries out what they decided. [`world`] is the game around them.
//!
//! ```sh
